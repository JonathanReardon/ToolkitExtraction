...
from AttributeIDList import out_teach_type_CEDIL
import pandas as pd

load_json()

# get gender data
out_teach_type = comments(out_teach_type_CEDIL)
out_teach_type_df = pd.DataFrame(out_teach_type)
out_teach_type_df = out_teach_type_df.T
out_teach_type_df.columns=["out_teach_type_info"]
