...
from AttributeIDList import intervention_session_length_CEDIL
import pandas as pd
...
InterventionSessionLength_HT = highlighted_text(intervention_session_length_CEDIL)
...
InterventionSessionLength_Comments = comments(intervention_session_length_CEDIL)
