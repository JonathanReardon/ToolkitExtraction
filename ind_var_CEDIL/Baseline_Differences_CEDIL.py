...
from AttributeIDList import baseline_differences_CEDIL
import pandas as pd

load_json()

# extract baseline differences data
baselinedifferences = get_data(baseline_differences_CEDIL)
...
baselinedifferences_HT = highlighted_text(baseline_differences_CEDIL)
...
baselinedifferences_Comments = comments(baseline_differences_CEDIL)
