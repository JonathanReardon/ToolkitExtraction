...
from AttributeIDList import intervention_delivery_CEDIL
import pandas as pd
...
InterventionDelivery = get_data(intervention_delivery_CEDIL)
...
InterventionDelivery_HT = highlighted_text(intervention_delivery_CEDIL)
...
InterventionDelivery_Comments = comments(intervention_delivery_CEDIL)
...
print(intervention_delivery_df)
