...
from AttributeIDList import study_realism_CEDIL
import pandas as pd
...
studyrealism = get_data(study_realism_CEDIL)
...
studyrealism_HT = highlighted_text(study_realism_CEDIL)
...
studyrealism_Comments = comments(study_realism_CEDIL)
