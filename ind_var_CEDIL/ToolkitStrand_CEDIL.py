...
from AttributeIDList import toolkit_strand_CEDIL
import pandas as pd
...
toolkitstrand = get_outcome_lvl2(toolkit_strand_CEDIL)
toolkitstrand_df = pd.DataFrame(toolkitstrand)

# get toolkit strand comments
toolkitstrand_Comments = comments(toolkit_strand_CEDIL)
