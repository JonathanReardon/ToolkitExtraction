...
from AttributeIDList import desc_stats_primary_CEDIL
import pandas as pd
...
DescStatsPrimaryOutcomeReported = get_data(desc_stats_primary_CEDIL)
...
DescStatsPrimaryOutcomeReported_HT = highlighted_text(desc_stats_primary_CEDIL)
...
DescStatsPrimaryOutcomeReported_Comments = comments(desc_stats_primary_CEDIL)
