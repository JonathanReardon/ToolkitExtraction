...
from AttributeIDList import proportion_low_fsm_CEDIL
from AttributeIDList import percentage_low_fsm_CEDIL
from AttributeIDList import further_ses_fsm_info_CEDIL
from AttributeIDList import no_ses_fsm_info_provided_CEDIL
import pandas as pd
...
low_ses_proportion_Comments = comments(proportion_low_fsm_CEDIL)
...
low_ses_proportion_HT = highlighted_text(proportion_low_fsm_CEDIL)
...
low_ses_percentage_Comments = comments(percentage_low_fsm_CEDIL)
...
low_ses_percentage_HT = highlighted_text(percentage_low_fsm_CEDIL)
...
further_ses_info_Comments = comments(further_ses_fsm_info_CEDIL)
...
further_ses_fsm_info_HT = highlighted_text(further_ses_fsm_info_CEDIL)
...
no_low_ses_fsm_info = get_data(no_ses_fsm_info_provided_CEDIL)
...
no_low_ses_fsm_info_comments = comments(no_ses_fsm_info_provided_CEDIL)
