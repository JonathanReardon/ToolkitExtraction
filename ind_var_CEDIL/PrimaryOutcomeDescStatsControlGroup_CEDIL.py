...
from AttributeIDList import control_group_number_CEDIL
from AttributeIDList import control_group_pretest_mean_CEDIL
from AttributeIDList import control_group_pretest_sd_CEDIL
from AttributeIDList import control_group_posttest_mean_CEDIL
from AttributeIDList import control_group_posttest_sd_CEDIL
from AttributeIDList import control_group_gain_score_mean_CEDIL
from AttributeIDList import control_group_gain_score_sd_CEDIL
from AttributeIDList import control_group_any_other_info_CEDIL
...
ControlGroupNumber_HT = highlighted_text(control_group_number_CEDIL)
...
ControlGroupNumber_comments = comments(control_group_number_CEDIL)
...
ControlGroupPretestMean_HT = highlighted_text(control_group_pretest_mean_CEDIL)
...
ControlGroupPretestMean_comments = comments(control_group_pretest_mean_CEDIL)
...
ControlGroupPretestSD_HT = highlighted_text(control_group_pretest_sd_CEDIL)
...
ControlGroupPretestSD_comments = comments(control_group_pretest_sd_CEDIL)
...
ControlGroupPostTestMean_HT = highlighted_text(control_group_posttest_mean_CEDIL)
...
ControlGroupPostTestMean_comments = comments(control_group_posttest_mean_CEDIL)
...
ControlGroupPostTestSD_HT = highlighted_text(control_group_posttest_sd_CEDIL)
...
ControlGroupPostTestSD_comments = comments(control_group_posttest_sd_CEDIL)
...
ControlGroupGainScoreMean_HT = highlighted_text(control_group_gain_score_mean_CEDIL)
...
ControlGroupGainScoreMean_comments = comments(control_group_gain_score_mean_CEDIL)
...
ControlGroupGainScoreSD_HT = highlighted_text(control_group_gain_score_sd_CEDIL)
...
ControlGroupGainScoreSD_comments = comments(control_group_gain_score_sd_CEDIL)
...
ControlGroupOtherInfo_HT = highlighted_text(control_group_any_other_info_CEDIL)
...
ControlGroupOtherInfo_comments = comments(control_group_any_other_info_CEDIL)
