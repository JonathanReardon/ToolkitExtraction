...
from AttributeIDList import intervention_time_CEDIL
import pandas as pd
...
InterventionTime = get_data(intervention_time_CEDIL)
...
InterventionTime_HT = highlighted_text(intervention_time_CEDIL)
...
InterventionTime_Comments = comments(intervention_time_CEDIL)
