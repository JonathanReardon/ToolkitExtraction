...
from AttributeIDList import intervention_training_provided_CEDIL
import pandas as pd
...
InterventionTrainingProvided = get_data(intervention_training_provided_CEDIL)
...
InterventionTrainingProvided_HT = highlighted_text(intervention_training_provided_CEDIL)
...
InterventionTrainingProvided_Comments = comments(intervention_training_provided_CEDIL)
