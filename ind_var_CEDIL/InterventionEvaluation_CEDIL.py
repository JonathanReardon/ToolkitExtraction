...
from AttributeIDList import intervention_evaluation_CEDIL
import pandas as pd
...
InterventionEvaluation = get_data(intervention_evaluation_CEDIL)
...
InterventionEvaluation_HT = highlighted_text(intervention_evaluation_CEDIL)
...
InterventionEvaluation_Comments = comments(intervention_evaluation_CEDIL)
...
print(intervention_evaluation_df)
