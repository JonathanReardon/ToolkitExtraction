...
from AttributeIDList import comparabiltiy_vars_reported_CEDIL
from AttributeIDList import if_yes_which_comparability_variables_reported_CEDIL
import pandas as pd
...
comparability_vars_reported = get_data(comparabiltiy_vars_reported_CEDIL)
...
comparability_vars_reported_HT = highlighted_text(comparabiltiy_vars_reported_CEDIL)
...
comparability_vars_reported_Comments = comments(comparabiltiy_vars_reported_CEDIL)
...
which_comparability_vars_reported = get_data(if_yes_which_comparability_variables_reported_CEDIL)
...
# Get Comparability Variables Reported highlighted text
which_comparability_vars_reported_df_HT = highlighted_text(if_yes_which_comparability_variables_reported_CEDIL)
...
# Get Comparability Variables Reported user comments
which_comparability_vars_reported_Comments = comments(if_yes_which_comparability_variables_reported_CEDIL)
