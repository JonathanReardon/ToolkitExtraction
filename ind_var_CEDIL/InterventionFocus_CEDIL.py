...
from AttributeIDList import intervention_focus_CEDIL
import pandas as pd
...
InterventionFocus = get_data(intervention_focus_CEDIL)
...
InterventionFocus_HT = highlighted_text(intervention_focus_CEDIL)
...
InterventionFocus_Comments = comments(intervention_focus_CEDIL)
