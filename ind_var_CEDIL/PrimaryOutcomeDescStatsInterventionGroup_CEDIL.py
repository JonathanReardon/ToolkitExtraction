...
from AttributeIDList import intervention_group_number_CEDIL
from AttributeIDList import intervention_group_pretest_mean_CEDIL
from AttributeIDList import intervention_group_pretest_sd_CEDIL
from AttributeIDList import intervention_group_posttest_mean_CEDIL
from AttributeIDList import intervention_group_posttest_sd_CEDIL
from AttributeIDList import intervention_group_gain_score_mean_CEDIL
from AttributeIDList import intervention_group_gain_score_sd_CEDIL
from AttributeIDList import intervention_group_any_other_info_CEDIL
import pandas as pd
...
InterventionGroupNumber_HT = highlighted_text(intervention_group_number_CEDIL)
...
InterventionGroupNumber_comments = comments(intervention_group_number_CEDIL)
...
InterventionGroupPretestMean_HT = highlighted_text(intervention_group_pretest_mean_CEDIL)
...
InterventionGroupPretestMean_comments = comments(intervention_group_pretest_mean_CEDIL)
...
InterventionGroupPretestSD_HT = highlighted_text(intervention_group_pretest_sd_CEDIL)
...
InterventionGroupPretestSD_comments = comments(intervention_group_pretest_sd_CEDIL)
...
InterventionGroupPostTestMean_HT = highlighted_text(intervention_group_posttest_mean_CEDIL)
...
InterventionGroupPostTestMean_comments = comments(intervention_group_posttest_mean_CEDIL)
...
InterventionGroupPostTestSD_HT = highlighted_text(intervention_group_posttest_sd_CEDIL)
...
InterventionGroupPostTestSD_comments = comments(intervention_group_posttest_sd_CEDIL)
...
InterventionGroupGainScoreMean_HT = highlighted_text(intervention_group_gain_score_mean_CEDIL)
...
InterventionGroupGainScoreMean_comments = comments(intervention_group_gain_score_mean_CEDIL)
...
InterventionGroupGainScoreSD_HT = highlighted_text(intervention_group_gain_score_sd_CEDIL)
...
InterventionGroupGainScoreSD_comments = comments(intervention_group_gain_score_sd_CEDIL)
...
InterventionGroupOtherInfo_HT = highlighted_text(intervention_group_any_other_info_CEDIL)
...
InterventionGroupOtherInfo_comments = comments(intervention_group_any_other_info_CEDIL)
