...
from AttributeIDList import other_outcomes_CEDIL
from AttributeIDList import additional_outcomes_CEDIL
from AttributeIDList import other_participants_CEDIL
import pandas as pd
...
other_outcomes = get_data(other_outcomes_CEDIL)
...
other_outcomes_HT = highlighted_text(other_outcomes_CEDIL)
...
other_outcomes_info = comments(other_outcomes_CEDIL)
...
additional_outcomes = get_data(additional_outcomes_CEDIL)
...
additional_outcomes_ht = highlighted_text(additional_outcomes_CEDIL)
...
additional_outcomes_info = comments(additional_outcomes_CEDIL)
...
other_participants_ht = highlighted_text(other_participants_CEDIL)
...
other_participants_info = comments(other_participants_CEDIL)
