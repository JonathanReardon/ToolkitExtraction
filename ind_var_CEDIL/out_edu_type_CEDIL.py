...
from AttributeIDList import out_edu_type_CEDIL
import pandas as pd

load_json()

# get gender data
out_edu_type = get_data(out_edu_type_CEDIL)
out_edu_type_df = pd.DataFrame(out_edu_type)
out_edu_type_df = out_edu_type_df.T
out_edu_type_df.columns=["out_edu_type_raw"]
