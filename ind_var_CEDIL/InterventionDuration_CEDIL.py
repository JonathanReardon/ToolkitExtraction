...
from AttributeIDList import intervention_duration_CEDIL
import pandas as pd
...
InterventionDuration_HT = highlighted_text(intervention_duration_CEDIL)
...
InterventionDuration_Comments = comments(intervention_duration_CEDIL)
