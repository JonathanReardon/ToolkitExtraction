...
from AttributeIDList import control_group_two_number_CEDIL
from AttributeIDList import control_group_two_pretest_mean_CEDIL
from AttributeIDList import control_group_two_pretest_sd_CEDIL
from AttributeIDList import control_group_two_posttest_mean_CEDIL
from AttributeIDList import control_group_two_posttest_sd_CEDIL
from AttributeIDList import control_group_two_gain_score_mean_CEDIL
from AttributeIDList import control_group_two_gain_score_sd_CEDIL
from AttributeIDList import control_group_two_any_other_info_CEDIL
from AttributeIDList import follow_up_data_reported_CEDIL
import pandas as pd
...
ControlGroupNumber_HT = highlighted_text(control_group_two_number_CEDIL)
...
ControlGroupNumber_comments = comments(control_group_two_number_CEDIL)
...
ControlGroupPretestMean_HT = highlighted_text(control_group_two_pretest_mean_CEDIL)
...
ControlGroupPretestMean_comments = comments(control_group_two_pretest_mean_CEDIL)
...
ControlGroupPretestSD_HT = highlighted_text(control_group_two_pretest_sd_CEDIL)
...
ControlGroupPretestSD_comments = comments(control_group_two_pretest_sd_CEDIL)
...
ControlGroupPostTestMean_HT = highlighted_text(control_group_two_posttest_mean_CEDIL)
...
ControlGroupPostTestMean_comments = comments(control_group_two_posttest_mean_CEDIL)
...
ControlGroupPostTestSD_HT = highlighted_text(control_group_two_posttest_sd_CEDIL)
...
ControlGroupPostTestSD_comments = comments(control_group_two_posttest_sd_CEDIL)
...
ControlGroupGainScoreMean_HT = highlighted_text(control_group_two_gain_score_mean_CEDIL)
...
ControlGroupGainScoreMean_comments = comments(control_group_two_gain_score_mean_CEDIL)
...
ControlGroupGainScoreSD_HT = highlighted_text(control_group_two_gain_score_sd_CEDIL)
...
ControlGroupGainScoreSD_comments = comments(control_group_two_gain_score_sd_CEDIL)
...
ControlGroupOtherInfo_HT = highlighted_text(control_group_two_any_other_info_CEDIL)
...
ControlGroupOtherInfo_comments = comments(control_group_two_any_other_info_CEDIL)
...
# Get Follow Up Data
followupdata = get_data(follow_up_data_reported_CEDIL)
...
followupdata_HT = highlighted_text(follow_up_data_reported_CEDIL)
...
followupdata_comments = comments(follow_up_data_reported_CEDIL)
...
# save to disk
""" DescStatsPrimaryOutcomeReported_Control_TWO_df.fillna("NA", inplace=True) """

print(DescStatsPrimaryOutcomeReported_Control_TWO_df)
