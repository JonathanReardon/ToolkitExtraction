...
from AttributeIDList import study_design_CEDIL
import pandas as pd
...
studydesign = get_data(study_design_CEDIL)
...
studydesign_HT = highlighted_text(study_design_CEDIL)
...
studydesign_Comments = comments(study_design_CEDIL)
