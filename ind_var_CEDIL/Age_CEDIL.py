...
from AttributeIDList import student_age_CEDIL
import pandas as pd

load_json()

# get age data
student_age = get_data(student_age_CEDIL)
...
student_age_HT = highlighted_text(student_age_CEDIL)
...
student_age_Comments = comments(student_age_CEDIL)
