...
from AttributeIDList import sample_size_analyzed_intervention_CEDIL
from AttributeIDList import sample_size_analyzed_control_CEDIL
from AttributeIDList import sample_size_analyzed_second_intervention_CEDIL
from AttributeIDList import sample_size_analyzed_second_control_CEDIL
import pandas as pd
...
# highlighted text
sample_size_analyzed_intervention = highlighted_text(sample_size_analyzed_intervention_CEDIL)
...
# comments
sample_size_analyzed_intervention_Comments = comments(sample_size_analyzed_intervention_CEDIL)
...
# highlighted text
sample_size_analyzed_control = highlighted_text(sample_size_analyzed_control_CEDIL)
...
# comments
sample_size__anazlyed_control_Comments = comments(sample_size_analyzed_control_CEDIL)
...
# highlighted text
sample_size_analyzed_second_intervention = highlighted_text(sample_size_analyzed_second_intervention_CEDIL)
...
# comments
sample_size_analyzed_second_intervention_Comments = comments(sample_size_analyzed_second_intervention_CEDIL)
...
# highlighted text
sample_size_analyzed_second_control = highlighted_text(sample_size_analyzed_second_control_CEDIL)
...
# comments
sample_size_analyzed_second_control_Comments = comments(sample_size_analyzed_second_control_CEDIL)
