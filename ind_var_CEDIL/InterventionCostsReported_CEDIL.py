...
from AttributeIDList import intervention_costs_reported_CEDIL
import pandas as pd
...
InterventionCosts = get_data(intervention_costs_reported_CEDIL)
...
InterventionCosts_HT = highlighted_text(intervention_costs_reported_CEDIL)
...
InterventionCosts_Comments = comments(intervention_costs_reported_CEDIL)
