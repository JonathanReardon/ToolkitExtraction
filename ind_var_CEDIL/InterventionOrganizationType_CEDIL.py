...
from AttributeIDList import intervention_organisation_type_CEDIL
import pandas as pd
...
InterventionOrgType = get_data(intervention_organisation_type_CEDIL)
...
InterventionOrgType_HT = highlighted_text(intervention_organisation_type_CEDIL)
...
InterventionOrgType_Comments = comments(intervention_organisation_type_CEDIL)
