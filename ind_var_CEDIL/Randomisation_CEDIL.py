...
from AttributeIDList import randomisation_details_CEDIL
import pandas as pd
...
randomisation = get_data(randomisation_details_CEDIL)
...
randomisation_HT = highlighted_text(randomisation_details_CEDIL)
...
randomisation_Comments = comments(randomisation_details_CEDIL)
