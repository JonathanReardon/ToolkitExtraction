...
from AttributeIDList import intervention_teaching_approach_CEDIL
import pandas as pd
...
InterventionTeachingApproach = get_data(intervention_teaching_approach_CEDIL)
...
InterventionTeachingApproach_HT = highlighted_text(intervention_teaching_approach_CEDIL)
...
InterventionTeachingApproach_Comments = comments(intervention_teaching_approach_CEDIL)
