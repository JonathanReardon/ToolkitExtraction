...
from AttributeIDList import intervention_name_CEDIL
import pandas as pd
...
Intervention_NameHT = highlighted_text(intervention_name_CEDIL)
...
Intervention_Name_Comments = comments(intervention_name_CEDIL)
