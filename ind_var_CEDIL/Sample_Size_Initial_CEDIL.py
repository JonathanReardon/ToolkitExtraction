...
from AttributeIDList import sample_size_intervention_CEDIL
from AttributeIDList import sample_size_control_CEDIL
from AttributeIDList import sample_size_second_intervention_CEDIL
from AttributeIDList import sample_size_third_intervention_CEDIL
import pandas as pd
...
sample_size_intervention_HT = highlighted_text(sample_size_intervention_CEDIL)
...
sample_size_intervention_Comments = comments(sample_size_intervention_CEDIL)
...
sample_size_control_HT = highlighted_text(sample_size_control_CEDIL)
...
sample_size_control_Comments = comments(sample_size_control_CEDIL)
...
sample_size_second_intervention_HT = highlighted_text(sample_size_second_intervention_CEDIL)
...
sample_size_second_intervention_Comments = comments(sample_size_second_intervention_CEDIL)
...
sample_size_third_intervention_HT = highlighted_text(sample_size_third_intervention_CEDIL)
...
sample_size_third_intervention_Comments = comments(sample_size_third_intervention_CEDIL)
