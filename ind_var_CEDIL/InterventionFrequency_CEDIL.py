...
from AttributeIDList import intervention_frequency_CEDIL
import pandas as pd
...
InterventionFrequency_HT = highlighted_text(intervention_frequency_CEDIL)
...
InterventionFrequency_Comments = comments(intervention_frequency_CEDIL)
