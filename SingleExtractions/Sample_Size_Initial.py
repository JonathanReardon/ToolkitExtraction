...
# highlighted text
sample_size_intervention = var_highlighted_text(
...
# comments
sample_size_intervention_comments = var_comments(
    sample_size_intervention_output)
...
# highlighted text
sample_size_second_intervention = var_highlighted_text(
    sample_size_second_intervention_output)
sample_size_second_intervention_df = pd.DataFrame(
    sample_size_second_intervention)
...
# comments
sample_size_second_intervention_comments = var_comments(
    sample_size_second_intervention_output)
sample_size_second_intervention_comments_df = pd.DataFrame(
    sample_size_second_intervention_comments)
...
# highlighted text
sample_size_third_intervention = var_highlighted_text(
    sample_size_third_intervention_output)
sample_size_third_intervention_df = pd.DataFrame(
    sample_size_third_intervention)
...
# comments
sample_size_third_intervention_comments = var_comments(
    sample_size_third_intervention_output)
sample_size_third_intervention_comments_df = pd.DataFrame(
    sample_size_third_intervention_comments)
