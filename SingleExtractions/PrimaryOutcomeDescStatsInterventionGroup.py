...
InterventionGroupPretestMean_HT_df.columns = ["Intervention_Group_Pre-test_Mean_HT"]
...
InterventionGroupPretestMean_comments_df.columns = ["Intervention_Group_Pre-test_Mean_comments"]
...
InterventionGroupPretestSD_HT_df.columns = ["Intervention_Group_Pre-test_SD_HT"]
...
InterventionGroupPretestSD_comments_df.columns = ["Intervention_Group_Pre-test_SD_comments"]
...
InterventionGroupPostTestMean_HT_df.columns = ["Intervention_Group_Post-test_Mean_HT"]
...
InterventionGroupPostTestMean_comments_df.columns = ["Intervention_Group_Post-test_Mean_comments"]
...
InterventionGroupPostTestSD_HT_df.columns = ["Intervention_Group_Post-test_SD_HT"]
...
InterventionGroupPostTestSD_comments_df.columns = ["Intervention_Group_Post-test_SD_comments"]
...
InterventionGroupGainScoreMean_HT_df.columns = ["Intervention_Group_Gain_Score_Mean_HT"]
...
InterventionGroupGainScoreMean_comments_df.columns = ["Intervention_Group_Gain_Score_Mean_comments"]
...
InterventionGroupGainScoreSD_HT_df.columns = ["Intervention_Group_Gain_Score_SD_HT"]
...
InterventionGroupGainScoreSD_comments_df.columns = ["Intervention_Group_Gain_Score_SD_comments"]
...
InterventionGroupOtherInfo_HT_df.columns = ["Intervention_Group_Other_Info_HT"]
...
InterventionGroupOtherInfo_comments_df.columns = ["Intervention_Group_Other_Info_comments"]

# concatenate data frames
DescStatsPrimaryOutcomeReported_Intervention_df = pd.concat([InterventionGroupNumber_HT_df, InterventionGroupNumber_comments_df,
