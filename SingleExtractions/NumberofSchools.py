...
number_of_schools_intervention = var_comments(
    number_of_schools_intervention_output)
number_of_schools_intervention_df = pd.DataFrame(
    number_of_schools_intervention)
...
number_of_schools_intervention_comments = var_highlighted_text(
    number_of_schools_intervention_output)
...
number_of_schools_control_comments = var_highlighted_text(
    number_of_schools_control_output)
number_of_schools_control_comments_df = pd.DataFrame(
    number_of_schools_control_comments)
...
number_of_schools_total_comments = var_highlighted_text(
    number_of_schools_total_output)
number_of_schools_total_comments_df = pd.DataFrame(
...
number_of_schools_not_provided = var_comments(
    number_of_schools_not_provided_output)

number_of_schools_not_provided_df = pd.DataFrame(
    number_of_schools_not_provided)
...
number_of_schools_not_provided_comments = var_highlighted_text(
    number_of_schools_not_provided_output)

number_of_schools_not_provided_comments_df = pd.DataFrame(
    number_of_schools_not_provided_comments)
