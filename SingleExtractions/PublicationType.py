...
publicationtype_df.columns=["pub_type"]
...
publication_type_df = pd.concat([publicationtype_df, publicationtype_HT_df, publicationtype_Comments_df], axis=1, sort=False)
