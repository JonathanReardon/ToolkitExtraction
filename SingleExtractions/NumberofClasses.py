...
number_of_classes_intervention = comments(
    number_of_classes_intervention_output)
number_of_classes_intervention_df = pd.DataFrame(
    number_of_classes_intervention)
...
number_of_classes_intervention_comments = var_highlighted_text(
    number_of_classes_intervention_output)
...
number_of_classes_control_comments = var_highlighted_text(
...
number_of_classes_total_comments = var_highlighted_text(
    number_of_classes_total_output)
number_of_classes_total_comments_df = pd.DataFrame(
...
number_of_classes_not_provided = comments(
    number_of_classes_not_provided_output)
number_of_classes_not_provided_df = pd.DataFrame(
    number_of_classes_not_provided)
...
number_of_classes_not_provided_comments = var_highlighted_text(
    number_of_classes_not_provided_output)
