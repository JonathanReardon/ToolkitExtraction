...
all_variables = pd.concat([eppiid_df, author_df, year_df, admin_strand_df, intervention_name_df, intervention_description_df,
                           ...
                           comparability_vars_reported_df, clustering_df], axis=1, sort=False)
...
all_variables.to_csv("DataFrame2.csv", index=False) 
