...
# highlighted text
sample_size_analyzed_intervention = var_highlighted_text(
...
# comments
sample_size_analyzed_intervention_comments = var_comments(
    sample_size_analyzed_intervention_output)
...
# highlighted text
sample_size_analyzed_control = var_highlighted_text(
...
# comments
sample_size__anazlyed_control_comments = var_comments(
    sample_size_analyzed_control_output)
sample_size__anazlyed_control_comments_df = pd.DataFrame(
    sample_size__anazlyed_control_comments)
...
# highlighted text
sample_size_analyzed_second_intervention = var_highlighted_text(
    sample_size_analyzed_second_intervention_output)
sample_size_analyzed_second_intervention_df = pd.DataFrame(
    sample_size_analyzed_second_intervention)
...
# comments
sample_size_analyzed_second_intervention_comments = var_comments(
    sample_size_analyzed_second_intervention_output)
sample_size_analyzed_second_intervention_comments_df = pd.DataFrame(
    sample_size_analyzed_second_intervention_comments)
sample_size_analyzed_second_intervention_comments_df = sample_size_analyzed_second_intervention_comments_df.T
sample_size_analyzed_second_intervention_comments_df.columns = [
    "n_treat2_info"]
...
# highlighted text
sample_size_analyzed_second_control = var_highlighted_text(
    sample_size_analyzed_second_control_output)
sample_size_analyzed_second_control_df = pd.DataFrame(
    sample_size_analyzed_second_control)
...
# comments
sample_size_analyzed_second_control_comments = var_comments(
    sample_size_analyzed_second_control_output)
sample_size_analyzed_second_control_comments_df = pd.DataFrame(
    sample_size_analyzed_second_control_comments)
