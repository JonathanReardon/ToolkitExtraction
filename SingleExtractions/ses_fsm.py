...
low_ses_proportion = var_comments(proportion_low_fsm_output)
low_ses_proportion_df = pd.DataFrame(low_ses_proportion)
low_ses_proportion_df = low_ses_proportion_df.T
low_ses_proportion_df.columns = ["fsm_prop_info"]

low_ses_proportion_comments = var_highlighted_text(proportion_low_fsm_output)
...
low_ses_proportion_comments_df.columns = ["fsm_prop_ht"]
...
further_ses_fsm_info_comments = var_highlighted_text(
...
no_low_ses_fsm_info_comments = var_comments(no_ses_fsm_info_provided_output)
...
ses_fsm_df = pd.concat([low_ses_proportion_df, low_ses_proportion_comments_df,
                        low_ses_percentage_df, low_ses_percentage_comments_df,
                        further_ses_fsm_info_df, further_ses_fsm_info_comments_df,
                        no_low_ses_fsm_info_df, no_low_ses_fsm_info_comments_df], axis=1, sort=False)
