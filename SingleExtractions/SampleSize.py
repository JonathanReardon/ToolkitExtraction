...
samplesize_df = pd.DataFrame(sample_size)
samplesize_df = samplesize_df.T
samplesize_df.columns = ["sample_analysed_info"]
...
sample_size_df = pd.concat(
    [sample_size_comments_df, samplesize_df], axis=1, sort=False)
