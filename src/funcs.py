...
class JSONDataExtractor:
    ...
    def get_data(self, codes):
        ...
        for var in range(len(codes)):
            holder = []
            for section in range(len(self.data["References"])):
                if "Codes" in self.data["References"][section]:
                    holderfind = []
                    for study in range(len(self.data["References"][section]["Codes"])):
                        for key, value in codes[var].items():
                            if key == self.data["References"][section]["Codes"][study]["AttributeId"]:
            ...
            for section in range(len(self.data["References"])):
                if "Codes" in self.data["References"][section]:
                    ...
                    for study in range(len(self.data["References"][section]["Codes"])):
                        for key, value in codes[var].items():
                            if key == self.data["References"][section]["Codes"][study]["AttributeId"]:
                                if "AdditionalText" in self.data["References"][section]["Codes"][study]:
                                    user_comments = self.data["References"][section]["Codes"][study]["AdditionalText"]
            ...
            for section in range(len(self.data["References"])):
                if "Codes" in self.data["References"][section]:
                    ...
                    for study in range(len(self.data["References"][section]["Codes"])):
                        for key, value in codes[var].items():
                            if key == self.data["References"][section]["Codes"][study]["AttributeId"]:
                                if "ItemAttributeFullTextDetails" in self.data["References"][section]["Codes"][study]:
                                    if self.data["References"][section]["Codes"][study]["ItemAttributeFullTextDetails"]:
                                        for i in range(len(self.data["References"][section]["Codes"][study]["ItemAttributeFullTextDetails"])):
                                            user_highlighted_text.append(
                                                self.data["References"][section]["Codes"][study]["ItemAttributeFullTextDetails"][i]["Text"])
    ...
    def get_outcome_lvl1(self, var):
        ...
        '''
        outcome_number=[]
        for study in range(len(self.data["References"])):
            if "Outcomes" in self.data["References"][study]:
                outcome_number.append(len(self.data["References"][study]["Outcomes"]))
        varlist = []
        for section in range(len(self.data["References"])):
            holder = []
            if "Outcomes" in self.data["References"][section]:
                for subsection in range(max(outcome_number)):
                    if subsection < len(self.data["References"][section]["Outcomes"]):
                        holder.append(self.data["References"][section]["Outcomes"][subsection][var])
                    else:
                        holder.append("NA")
    ...
    def get_outcome_lvl2(self, var):
        ...
        for variable in range(len(var)):
            for study in range(len(self.data["References"])):
                if "Codes" in self.data["References"][study]:
                    if "Outcomes" in self.data["References"][study]:
                        outerholder = []
                        for item in range(len(self.data["References"][study]["Outcomes"])):
                            innerholderholder = []
                            if "OutcomeCodes" in self.data["References"][study]["Outcomes"][item]:
                                for subsection in range(len(self.data["References"][study]["Outcomes"][item]["OutcomeCodes"]["OutcomeItemAttributesList"])):
                                    for key, value in var[variable].items():
                                        if key == self.data["References"][study]["Outcomes"][item]["OutcomeCodes"]["OutcomeItemAttributesList"][subsection]["AttributeId"]:
                                            innerholderholder.append(
                                                self.data["References"][study]["Outcomes"][item]["OutcomeCodes"]["OutcomeItemAttributesList"][subsection]["AttributeName"])
                            else:
