...
conditions = [df["out_tit_1"].str.startswith(("TE_SUB", "TE_PRI"))]
choices = [True]
...
conditions = [df["out_tit_2"].str.startswith(("TE_SUB", "TE_PRI"))]
choices = [True]
...
conditions = [df["out_tit_3"].str.startswith(("TE_SUB", "TE_PRI"))]
choices = [True]
...
conditions = [df["out_tit_4"].str.startswith(("TE_SUB", "TE_PRI"))]
choices = [True]
...
conditions = [df["out_tit_5"].str.startswith(("TE_SUB", "TE_PRI"))]
choices = [True]
...
conditions = [df["out_tit_6"].str.startswith(("TE_SUB", "TE_PRI"))]
choices = [True]
...
conditions = [df["out_tit_7"].str.startswith(("TE_SUB", "TE_PRI"))]
choices = [True]
...
conditions = [df["out_tit_8"].str.startswith(("TE_SUB", "TE_PRI"))]
choices = [True]
...
conditions = [df["out_tit_9"].str.startswith(("TE_SUB", "TE_PRI"))]
choices = [True]
...
conditions = [df["out_tit_10"].str.startswith(("TE_SUB", "TE_PRI"))]
choices = [True]
...
conditions = [df["out_tit_11"].str.startswith(("TE_SUB", "TE_PRI"))]
choices = [True]
...
df_all.to_csv("toolkit_outcome_check_TE.csv", index=False, header=True) """
