...
conditions = [df["out_label_1"].str.startswith("Primary")]
choices = [True]
...
conditions = [df["out_label_2"].str.startswith("Primary")]
choices = [True]
...
conditions = [df["out_label_3"].str.startswith("Primary")]
choices = [True]
...
conditions = [df["out_label_4"].str.startswith("Primary")]
choices = [True]
...
conditions = [df["out_label_5"].str.startswith("Primary")]
choices = [True]
...
conditions = [df["out_label_6"].str.startswith("Primary")]
choices = [True]
...
conditions = [df["out_label_7"].str.startswith("Primary")]
choices = [True]
...
conditions = [df["out_label_8"].str.startswith("Primary")]
choices = [True]
...
conditions = [df["out_label_9"].str.startswith("Primary")]
choices = [True]
...
conditions = [df["out_label_10"].str.startswith("Primary")]
choices = [True]
...
conditions = [df["out_label_11"].str.startswith("Primary")]
choices = [True]
...
df_all.to_csv("toolkit_outcome_check_PRI.csv", index=False, header=True) """
