...
from ind_var_SS.OL_strand_specific import ol_ss_df
...
for counter, row in enumerate(df['out_type_1']):
    if 'Toolkit primary outcome' in row:
        ...
        toolkit_out_testtype.append(df['out_test_type_raw_12'][counter])
    elif 'Toolkit primary outcome' in df['out_type_13'][counter]:
        toolkit_prim.append(df['out_type_13'][counter])
        toolkit_out_strand.append(df['out_strand_13'][counter])
        toolkit_prim_smd.append(df['smd_13'][counter])
        toolkit_prim_se.append(df['se_13'][counter])
        toolkit_out_tit.append(df['out_tit_13'][counter])
        toolkit_prim_sample.append(df['out_samp_13'][counter])
        toolkit_prim_outcomp.append(df['out_comp_13'][counter])
        toolkit_es_type.append(df['out_es_type_13'][counter])
        toolkit_out_measure.append(df['out_measure_13'][counter])
        toolkit_out_testtype.append(df['out_test_type_raw_13'][counter])
    elif 'Toolkit primary outcome' in df['out_type_14'][counter]:
        toolkit_prim.append(df['out_type_14'][counter])
        toolkit_out_strand.append(df['out_strand_14'][counter])
        toolkit_prim_smd.append(df['smd_14'][counter])
        toolkit_prim_se.append(df['se_14'][counter])
        toolkit_out_tit.append(df['out_tit_14'][counter])
        toolkit_prim_sample.append(df['out_samp_14'][counter])
        toolkit_prim_outcomp.append(df['out_comp_14'][counter])
        toolkit_es_type.append(df['out_es_type_14'][counter])
        toolkit_out_measure.append(df['out_measure_14'][counter])
        toolkit_out_testtype.append(df['out_test_type_raw_14'][counter])
    elif 'Toolkit primary outcome' in df['out_type_15'][counter]:
        toolkit_prim.append(df['out_type_15'][counter])
        toolkit_out_strand.append(df['out_strand_15'][counter])
        toolkit_prim_smd.append(df['smd_15'][counter])
        toolkit_prim_se.append(df['se_15'][counter])
        toolkit_out_tit.append(df['out_tit_15'][counter])
        toolkit_prim_sample.append(df['out_samp_15'][counter])
        toolkit_prim_outcomp.append(df['out_comp_15'][counter])
        toolkit_es_type.append(df['out_es_type_15'][counter])
        toolkit_out_measure.append(df['out_measure_15'][counter])
        toolkit_out_testtype.append(df['out_test_type_raw_15'][counter])
    elif 'Toolkit primary outcome' in df['out_type_16'][counter]:
        toolkit_prim.append(df['out_type_16'][counter])
        toolkit_out_strand.append(df['out_strand_16'][counter])
        toolkit_prim_smd.append(df['smd_16'][counter])
        toolkit_prim_se.append(df['se_16'][counter])
        toolkit_out_tit.append(df['out_tit_16'][counter])
        toolkit_prim_sample.append(df['out_samp_16'][counter])
        toolkit_prim_outcomp.append(df['out_comp_16'][counter])
        toolkit_es_type.append(df['out_es_type_16'][counter])
        toolkit_out_measure.append(df['out_measure_16'][counter])
        toolkit_out_testtype.append(df['out_test_type_raw_16'][counter])
...
for counter, row in enumerate(df['out_type_1']):
    ...
    elif 'Reading primary outcome' in df['out_type_13'][counter]:
        reading_prim.append(df['out_type_13'][counter])
        reading_prim_smd.append(df['smd_13'][counter])
        reading_prim_se.append(df['se_13'][counter])
    elif 'Reading primary outcome' in df['out_type_14'][counter]:
        reading_prim.append(df['out_type_14'][counter])
        reading_prim_smd.append(df['smd_14'][counter])
        reading_prim_se.append(df['se_14'][counter])
    elif 'Reading primary outcome' in df['out_type_15'][counter]:
        reading_prim.append(df['out_type_15'][counter])
        reading_prim_smd.append(df['smd_15'][counter])
        reading_prim_se.append(df['se_15'][counter])
    elif 'Reading primary outcome' in df['out_type_16'][counter]:
        reading_prim.append(df['out_type_16'][counter])
        reading_prim_smd.append(df['smd_16'][counter])
        reading_prim_se.append(df['se_16'][counter])
...
for counter, row in enumerate(df['out_type_1']):
    ...
    elif 'Writing and spelling primary outcome' in df['out_type_13'][counter]:
        Writing_and_spelling_prim.append(df['out_type_13'][counter])
        Writing_and_spelling_prim_smd.append(df['smd_13'][counter])
        Writing_and_spelling_prim_se.append(df['se_13'][counter])
    elif 'Writing and spelling primary outcome' in df['out_type_14'][counter]:
        Writing_and_spelling_prim.append(df['out_type_14'][counter])
        Writing_and_spelling_prim_smd.append(df['smd_14'][counter])
        Writing_and_spelling_prim_se.append(df['se_14'][counter])
    elif 'Writing and spelling primary outcome' in df['out_type_15'][counter]:
        Writing_and_spelling_prim.append(df['out_type_15'][counter])
        Writing_and_spelling_prim_smd.append(df['smd_15'][counter])
        Writing_and_spelling_prim_se.append(df['se_15'][counter])
    elif 'Writing and spelling primary outcome' in df['out_type_16'][counter]:
        Writing_and_spelling_prim.append(df['out_type_16'][counter])
        Writing_and_spelling_prim_smd.append(df['smd_16'][counter])
        Writing_and_spelling_prim_se.append(df['se_16'][counter])
...
for counter, row in enumerate(df['out_type_1']):
    ...
    elif 'Mathematics primary outcome' in df['out_type_13'][counter]:
        Mathematics_prim.append(df['out_type_13'][counter])
        Mathematics_prim_smd.append(df['smd_13'][counter])
        Mathematics_prim_se.append(df['se_13'][counter])
    elif 'Mathematics primary outcome' in df['out_type_14'][counter]:
        Mathematics_prim.append(df['out_type_14'][counter])
        Mathematics_prim_smd.append(df['smd_14'][counter])
        Mathematics_prim_se.append(df['se_14'][counter])
    elif 'Mathematics primary outcome' in df['out_type_15'][counter]:
        Mathematics_prim.append(df['out_type_15'][counter])
        Mathematics_prim_smd.append(df['smd_15'][counter])
        Mathematics_prim_se.append(df['se_15'][counter])
    elif 'Mathematics primary outcome' in df['out_type_16'][counter]:
        Mathematics_prim.append(df['out_type_16'][counter])
        Mathematics_prim_smd.append(df['smd_16'][counter])
        Mathematics_prim_se.append(df['se_16'][counter])
...
for counter, row in enumerate(df['out_type_1']):
    ...
    elif 'Science primary outcome' in df['out_type_13'][counter]:
        Science_prim.append(df['out_type_13'][counter])
        Science_prim_smd.append(df['smd_13'][counter])
        Science_prim_se.append(df['se_13'][counter])
    elif 'Science primary outcome' in df['out_type_14'][counter]:
        Science_prim.append(df['out_type_14'][counter])
        Science_prim_smd.append(df['smd_14'][counter])
        Science_prim_se.append(df['se_14'][counter])
    elif 'Science primary outcome' in df['out_type_15'][counter]:
        Science_prim.append(df['out_type_15'][counter])
        Science_prim_smd.append(df['smd_15'][counter])
        Science_prim_se.append(df['se_15'][counter])
    elif 'Science primary outcome' in df['out_type_16'][counter]:
        Science_prim.append(df['out_type_16'][counter])
        Science_prim_smd.append(df['smd_16'][counter])
        Science_prim_se.append(df['se_16'][counter])
...
for counter, row in enumerate(df['out_type_1']):
    ...
    elif 'SES/FSM outcome' in df['out_type_12'][counter]:
        fsm_prim.append(df['out_type_12'][counter])
        fsm_prim_smd.append(df['smd_12'][counter])
        fsm_prim_se.append(df['se_12'][counter])
    elif 'SES/FSM outcome' in df['out_type_13'][counter]:
        fsm_prim.append(df['out_type_13'][counter])
        fsm_prim_smd.append(df['smd_13'][counter])
        fsm_prim_se.append(df['se_13'][counter])
    elif 'SES/FSM outcome' in df['out_type_14'][counter]:
        fsm_prim.append(df['out_type_14'][counter])
        fsm_prim_smd.append(df['smd_14'][counter])
        fsm_prim_se.append(df['se_14'][counter])
    elif 'SES/FSM outcome' in df['out_type_15'][counter]:
        fsm_prim.append(df['out_type_15'][counter])
        fsm_prim_smd.append(df['smd_15'][counter])
        fsm_prim_se.append(df['se_15'][counter])
    elif 'SES/FSM outcome' in df['out_type_16'][counter]:
        fsm_prim.append(df['out_type_16'][counter])
        fsm_prim_smd.append(df['smd_16'][counter])
        fsm_prim_se.append(df['se_16'][counter])
...
df_all_OL_SS = pd.concat([df_all, ol_ss_df], axis=1, sort=False)

# remove problematic text from outputs
df_all_OL_SS.replace('\r', ' ', regex=True, inplace=True)
df_all_OL_SS.replace('\n', ' ', regex=True, inplace=True)
df_all_OL_SS.replace(':', ' ',  regex=True, inplace=True)
df_all_OL_SS.replace(';', ' ',  regex=True, inplace=True)

# replace NaN with NA
df_all_OL_SS = df_all_OL_SS.replace('NaN', 'NA', regex=True)

# list column names and position
for counter, i in enumerate(df_all_OL_SS):
    print(counter, i)

# useful info
print("Columns:", df_all_OL_SS.shape[1])
print("Rows:", df_all_OL_SS.shape[0])
print("Datapoints:", df_all_OL_SS.shape[0] * df_all_OL_SS.shape[1])
...
df_all_OL_SS.to_csv(outfile_name, index=False, header=True)
...
# get file name for output
outfile_name = "EY_CLA_20221209_filters_website.csv"
